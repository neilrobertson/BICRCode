...
if __name__ == '__main__':
    try:
        opts, args = getopt.getopt(sys.argv[1:], "", ["cpg-meth=","regions=","outputfile=","buildGenome="])
    ...
    def methPercentageDiff(values):
        ...
        if lmeth + lunmeth <= 5 or rmeth + runmeth <= 5:
            return 0
    ...
    for chrm,start,stop in regions:
        ...
        try:
            ...
            methDiff = methPercentageDiff(values)
