# Based on http://code.google.com/p/easydialogs-gtk/
# Changes made:
# a few variables not set correctly
# closing ProgressBar via __die__() now calls GTK runner to actually close it 
...
def _action(widget, dialog, list):
    ...
    if widget.get_name()== "ARGV_OPTION_GROUP":
        ...
        raise RuntimeError, "Unknown dialog item %d"%widget.get_name()   
